...
WHERE "hire-date" BETWEEN '12/31/1985' AND '01/01/1987';
...
SELECT dept_manager.emp_no, employees.last_name, employees.first_name, departments.dept_name
    FROM employees, dept_manager, dept_emp, departments 
...
SELECT last_name, COUNT(emp_no)  AS "freq_last_name_count" FROM employees
GROUP BY last_name
ORDER BY "freq_last_name_count" DESC;
